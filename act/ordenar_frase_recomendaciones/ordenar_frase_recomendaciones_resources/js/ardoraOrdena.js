...
} else {$("#ardoraQuest").html(vHtml+"<img id='playSound' class='imaLeft' src='ordenar_frase_recomendaciones_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
